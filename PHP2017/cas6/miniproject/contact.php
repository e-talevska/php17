...
if(isset($_POST['submit'])){
    ...
    if($phoneNumber == ""){
        $errors['phone']= "Phone number i required";
    }
}
$mail= " ";
if(isset($_POST['submit'])){
    $phoneNumber = trim ($_POST('adress'));
    if($mail == ""){
        $errors['adress']= "Email adress i required";
    }
}
                ...
                <form name="sentMessage" id="contactForm" novalidate>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="tel" "<?= $phoneNumber; ?>"  class="form-control" id="phone" name="phone" required data-validation-required-message="Please enter your phone number.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
