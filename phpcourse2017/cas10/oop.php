...
class Student {
    ...
    function __destruct() {
        ...
        function intro() {
            echo "I m $this->firstName $this->lastName" . " i moite predmeti se "
...
$student2 = new Student ("John", "Doe", ['Maths','Physics', 'Javascript']);
//$student2 -> firstName = "John";
//$student2 -> lastName = "Doe";
//$student2 -> subjects = ['Maths','Physics', 'Javascript'];
$student2 -> intro();
